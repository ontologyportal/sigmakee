...
public class LanguageFormatterTest extends UnitTestBase {
    ...
    public void testVariableReplaceBasic() {
        ...
        String expectedAgent = "there exist &%Process$\"a  process X\" and &%AutonomousAgent$\"an agent Y\" such that &%Process$\"the process X\" is an &%instance$\"instance\" of &%Driving$\"driving\" and &%AutonomousAgent$\"the agent Y\" is an &%instance$\"instance\" of &%Human$\"human\" and &%AutonomousAgent$\"the agent Y\" is an &%agent$\"agent\" of &%Process$\"the process X\"";
        String expectedAutonomousAgent = "there exist &%Process$\"a  process X\" and &%AutonomousAgent$\"a   Autonomous agent Y\" such that &%Process$\"the process X\" is an &%instance$\"instance\" of &%Driving$\"driving\" and &%AutonomousAgent$\"the  Autonomous agent Y\" is an &%instance$\"instance\" of &%Human$\"human\" and &%AutonomousAgent$\"the  Autonomous agent Y\" is an &%agent$\"agent\" of &%Process$\"the process X\"";
        ...
        assertTrue(
            "Unexpected variable replacement output:\n" + actual,
            expectedAgent.equals(actual) || expectedAutonomousAgent.equals(actual)
        );
    }
