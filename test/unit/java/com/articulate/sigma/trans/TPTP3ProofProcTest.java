...
public class TPTP3ProofProcTest extends UnitTestBase {
    ...
    public void testGetPrologArgs4() {
        ...
        String input = "fof(f185,conjecture,(" +
                    ...
                    "  file('" + System.getProperty("user.home") + ".sigmakee/KBs/temp-comb.tptp',unknown)).";
    ...
    public void testParseProofStep () {
        ...
        System.out.println("TPTP3ProofProcTest: " + label);
        String ps1 = "fof(c_0_5, axiom, (s__subclass(s__Artifact,s__Object)), file('" + System.getProperty("user.home") + ".sigmakee/KBs/temp-comb.tptp', kb_SUMO_1234)).";
        ...
        String ps5 = "fof(f768,axiom,(! [X155,X156,X157,X158] : " +
                ...
                "s__instance(X159,s__TournamentSport))))),  file('" + System.getProperty("user.home") + ".sigmakee/KBs/temp-comb.tptp',kb_SUMO_768)).";
 ...
 //       System.out.println(tpp.parseProofStep(ps4));
    ...
    public void testProcessAnswersFromProof () {
        ...
        input.add("fof(f200,axiom,( s__instance(s__TransitFn__m,s__Relation)), file('" + System.getProperty("user.home") + ".sigmakee/KBs/temp-comb.tptp',kb_SUMO_200)).");
        ...
        input.add("fof(f392,conjecture,( ? [X16] : s__instance(X16,s__Relation)), file('" + System.getProperty("user.home") + ".sigmakee/KBs/temp-comb.tptp',query_0)).");
