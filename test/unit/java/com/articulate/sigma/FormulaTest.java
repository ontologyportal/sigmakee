...
*/
    ...
    public void testComplexArgumentsToArrayListDriving0() {
        ...
        assertEquals(normalizeWhitespace(expected), normalizeWhitespace(actual));
    }
    ...
    private static List<String> normalizeWhitespace(List<String> list) {
        List<String> result = new ArrayList<>();
        for (String s : list)
            result.add(s.replaceAll("\\s+", " ").trim());
        return result;
    }
}