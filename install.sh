...
sigma_install() {
	...
	sed -i '.original' "s|/home/vagrant/\.sigmakee|$SIGMA_HOME|g" $SIGMA_HOME/KBs/config.xml
	sed -i '.original' "s|/home/vagrant/workspace/sigma|$SIGMA_SRC|g" $SIGMA_HOME/KBs/config.xml
}
