...
<form action="LogLearn.jsp" method="get">
  ...
  <table>
    ...
    <tr>
      ...
      <td><input type="submit" name="populate" value="populate"></td>
    </tr>
    <% } %>
    <tr>
...
<%
/* ======================================================
   ADMIN: POPULATE ALL CACHES
   ====================================================== */
if ("admin".equalsIgnoreCase(role) && populate != null) {
    out.println("<b>Started populating all caches...</b><br>");
    try {
...
if ("submit".equalsIgnoreCase(action)) {
    ...
    // ---------------------------
    // ADMIN: Generate & append
    // ---------------------------
    if (admin && "true".equals(generate)) {
        out.println("<b>Generating and caching formulas...</b><br>");
        gpf.init();
        ...
        try (PrintWriter pw = new PrintWriter(new FileWriter(filePath, true))) {
            ...
            out.println("<p>Error writing cache: " + e.getMessage() + "</p>");
            e.printStackTrace();
        }
    }
    else {
