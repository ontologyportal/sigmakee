...
<%
    ...
    if (name == null) { response.setStatus(400); out.print("Bad request"); return; }

    // sanitize + whitelist extensions
    ...
    if (!file.startsWith(baseDir) || !Files.exists(file)) { response.setStatus(404); out.print("Test not found"); return; }
