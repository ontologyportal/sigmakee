...
<html>
  ...
  */
  ...
  <form action="Intersect.jsp">
    ...
    <table width="95%">
    <%
    if (forms == null || forms.size() == 0) out.println("<b>No intersection of terms " + term1 + " and " + term2 + " found.</b><P>");
    else out.println(HTMLformatter.formatFormulaList(forms,"",  kb, lang,  flang, 0, 0, ""));
    %>
    </table>
  <p>
