...
public class RewriteRuleLhsImpl extends ASTWrapperPsiElement implements RewriteRuleLhs {

  public RewriteRuleLhsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RewriteRuleVisitor) ((RewriteRuleVisitor)visitor).visitLhs(this);
