...
public class KB {
	 ...
	 *
	 * @param reln
	 *            A String denoting a SUO-KIF Relation
	 * @param argPos
	 ...
	 *
	 * @param i
	 *            A String denoting an instance.
	 * @param c
	 *            A String denoting a Class.
	 * @return true or false.
	 */
	 ...
	 *
	 * @param c1
	 *            A String, the name of a SetOrClass.
	 * @param c2
	 *            A String, the name of a SetOrClass.
	 * @return boolean
	 */
	 ...
	 *
	 * @param literal
	 *            A List representing a SUO-KIF formula.
	 ...
	 *
	 * @param knownArgnum
	 *            The argument position of knownArg
	 *
	 * @param knownArg
	 ...
	 *
	 * @param targetArgnum
	 *            The argument position of the terms being sought
	 *
	 ...
	 *
	 * @param kind
	 *            May be one of "ant", "cons", "stmt", or "arg"
	 * @see KIF.createKey()
	 * @param term
	 *            The term that appears in the statements being requested.
	 * @param argnum
	 ...
	 * @param fname
	 *            A String denoting the pathname of the target file.
	 ...
	 *
	 * @param input
	 *            The String representation of a SUO-KIF Formula.
	 *
	 ...
	 *
	 * @param suoKifFormula
	 *            The String representation of the SUO-KIF query.
	 *
	 * @param timeout
	 ...
	 *
	 * @param engine
	 *            InferenceEngine object that will be used for the inference.
	 *
	 * @return A String indicating the status of the ask operation.
	 */
