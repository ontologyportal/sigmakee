...
public class Edit {
    ...
    public static void editFile(String filename, int lineNumber) {
        ...
        if (editorCommand != null && !"".equals(editorCommand)) {
            execString.append(editorCommand).append(" ").append(filename);
            if (lineNumberCommand != null && !"".equals(lineNumberCommand))
                execString.append(" ").append(lineNumberCommand).append((Integer.valueOf(lineNumber)).toString());
            execString.append("')\">");
        }
