...
public class DocGen {
     ...
     */
    protected List getPredicates(KB kb, boolean requireNamespace) {
     ...
     * empty List
     */
    protected List getSubComponents(KB kb, String term) {
     ...
     * empty List
     */
    protected List getSuperComponents(KB kb, String term) {
     ...
     *
     */
    protected List getFirstInstances(KB kb, String term) {
     ...
     *
     */
    protected List getFirstSubClasses(KB kb, String term) {
            ...
            if (StringUtil.isNonEmptyString(term)) {
                if (isLegalForDisplay(term)) {
                    ...
                    if (StringUtil.emptyString(kbHref))
                        suffix = ".html";
                    List extensions = getSyntacticExtensionTerms(kb, term, 1, true);
                    /*
                ...
                if (relations != null && !relations.isEmpty()) {
                    ...
                    for (itr = relations.iterator(); itr.hasNext();) {
                        ...
                        if (!avoid.contains(relation)) {
                            statements = kb.askWithPredicateSubsumption(relation,
                                                                          1,
                                                                          term);
                            // if (isFormula) {
...
*/
                ...
                if (forms != null) {
                    ...
                    for (int i = 0; i < localLimit; i++) {
                        ...
                        result.append(NLGUtils.htmlParaphrase(kbHref,
                                ...
                                kb,
                                language)).append("<br>").append(StringUtil.getLineSeparator());
                    }
                }
            ...
            if (forms != null) {
                ...
                for (int i = 0; i < localLimit; i++) {
                    ...
                    result.append(NLGUtils.htmlParaphrase(kbHref,
                            ...
                            kb.getTermFormatMap(language),
                            kb,
                            language)).append(StringUtil.getLineSeparator());
                }
            }
            result.append(limitString);
            localLimit = limit;
     ...
     *
     */
    protected List getSyntacticExtensionTerms(KB kb,
                                                   String term,
                                                   int targetArgnum,
